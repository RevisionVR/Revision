    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Conversations_Educations_EducationId",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_DevicePayments", x => x.Id);
                table.ForeignKey(
                    name: "FK_DevicePayments_Educations_EducationId",
                    column: x => x.EducationId,
                    principalTable: "Educations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Devices_Educations_EducationId",
                    column: x => x.EducationId,
                    principalTable: "Educations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_EducationRooms", x => x.Id);
                table.ForeignKey(
                    name: "FK_EducationRooms_Educations_EducationId",
                    column: x => x.EducationId,
                    principalTable: "Educations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_TopicPayments", x => x.Id);
                table.ForeignKey(
                    name: "FK_TopicPayments_Educations_EducationId",
                    column: x => x.EducationId,
                    principalTable: "Educations",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade);
                table.ForeignKey(
                    name: "FK_TopicPayments_Topics_TopicId",
                    column: x => x.TopicId,
        ...
        migrationBuilder.CreateIndex(
            name: "IX_AdminRooms_RoomId",
            table: "AdminRooms",
            column: "RoomId");

        migrationBuilder.CreateIndex(
            name: "IX_AdminRooms_UserId",
            table: "AdminRooms",
            column: "UserId");

        migrationBuilder.CreateIndex(
            name: "IX_Conversations_EducationId",
            table: "Conversations",
            column: "EducationId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_DevicePayments_EducationId",
            table: "DevicePayments",
            column: "EducationId");

        migrationBuilder.CreateIndex(
            name: "IX_Devices_EducationId",
            table: "Devices",
            column: "EducationId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_EducationRooms_EducationId",
            table: "EducationRooms",
            column: "EducationId");

        migrationBuilder.CreateIndex(
            name: "IX_Educations_AddressId",
            table: "Educations",
            column: "AddressId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_TopicPayments_EducationId",
            table: "TopicPayments",
            column: "EducationId");

        migrationBuilder.CreateIndex(
            name: "IX_TopicPayments_TopicId",
            table: "TopicPayments",
            column: "TopicId");
